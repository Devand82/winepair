...
const FALLBACK_MODELS: ModelInfo[] = [
  ...
  { id: 'google/gemma-4-31b-it:free', name: 'Gemma 4 31B (Free)', supports_vision: true, provider: 'Google', description: 'Modello free. Supporta immagini.' },
  { id: 'google/gemma-4-26b-a4b-it:free', name: 'Gemma 4 26B (Free)', supports_vision: true, provider: 'Google', description: 'Modello free. Supporta immagini e JSON.' },
  { id: 'openai/gpt-oss-20b:free', name: 'GPT-OSS 20B (Free)', supports_vision: false, provider: 'OpenAI', description: 'Modello free. Solo testo.' },
  { id: 'nvidia/nemotron-3-super-120b-a12b:free', name: 'Nemotron 3 Super (Free)', supports_vision: false, provider: 'NVIDIA', description: 'Modello free. Solo testo.' },
  { id: 'nvidia/nemotron-nano-12b-v2-vl:free', name: 'Nemotron Nano VL (Free)', supports_vision: true, provider: 'NVIDIA', description: 'Modello free. Supporta immagini.' },
  { id: 'openai/gpt-5-nano', name: 'GPT-5 Nano', supports_vision: true, provider: 'OpenAI', description: 'Veloce, molto economico. Richiede credito.' },
  { id: 'google/gemma-3-27b-it', name: 'Gemma 3 27B', supports_vision: true, provider: 'Google', description: 'Economico, buon rapporto qualità/prezzo. Richiede credito.' },
  { id: 'google/gemini-2.5-flash-lite', name: 'Gemini 2.5 Flash Lite', supports_vision: true, provider: 'Google', description: 'Veloce, bassissimo costo, context 1M. Richiede credito.' },
  { id: 'openai/gpt-4.1-mini', name: 'GPT-4.1 Mini', supports_vision: true, provider: 'OpenAI', description: 'Ottimo per abbinamenti, context 1M. Richiede credito.' },
  ...
  { id: 'anthropic/claude-haiku-4.5', name: 'Claude Haiku 4.5', supports_vision: true, provider: 'Anthropic', description: 'Preciso, economico. Richiede credito.' },
];
